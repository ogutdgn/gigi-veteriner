...
function displaySingleBlog(blogId) {
    const blog = blogs.find(blog => blog.id === parseInt(blogId)); // ID'ye göre blogu bul
    console.log(document.querySelector('.blog-wrap-modern .content .title').textContent);

    if (blog) {
        document.querySelector('.blog-wrap-modern .img img').src = "assets/images/blog/blog_modern_large.jpg";
        document.querySelector('.entry-text-gap').textContent = blog.longDescription;
        document.querySelector('.blog-wrap-modern .content .title').textContent = blog.title;
        document.querySelector('.blog-wrap-modern .content .description').textContent = blog.shortDescription;
        document.querySelector('.blog-wrap-modern .content .bottom-content .thumb-author img').src = blog.authorImage;
        document.querySelector('.blog-wrap-modern .content .bottom-content .thumb-author').textContent = blog.author;
        document.querySelector('.blog-wrap-modern .content .bottom-content .date').textContent = blog.date;
